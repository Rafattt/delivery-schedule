...
class SingleDelivery extends Component {
    ...
    async componentDidMount(){
        await fetch('http://localhost:3000//api.php?table=delivery')
    ...
    render() {
        ...
        console.log(delDate);
        $.ajax({ url: 'http://localhost/createTable.php',
             method: 'POST',
             type: 'post',
             data: {
                 delDatevar:delDate
        ...
        cookies.set('deliveryTime', this.props.deliveryDate, { path: 'http://localhost:3000/' });
